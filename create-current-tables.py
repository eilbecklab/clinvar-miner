...
cursor.execute('CREATE INDEX IF NOT EXISTS current_submissions__normalized_gene ON current_submissions (normalized_gene)')
...
cursor.execute('CREATE INDEX IF NOT EXISTS current_comparisons__normalized_gene ON current_comparisons (normalized_gene)')
cursor.execute('CREATE INDEX IF NOT EXISTS current_comparisons__normalized_gene_type ON current_comparisons (normalized_gene_type)')
...
cursor.execute('CREATE INDEX IF NOT EXISTS current_comparisons__normalized_significance1 ON current_comparisons (normalized_significance1)')
...
cursor.execute('CREATE INDEX IF NOT EXISTS current_comparisons__normalized_method1 ON current_comparisons (normalized_method1)')
...
cursor.execute('CREATE INDEX IF NOT EXISTS current_comparisons__normalized_significance2 ON current_comparisons (normalized_significance2)')
cursor.execute('CREATE INDEX IF NOT EXISTS current_comparisons__star_level2 ON current_comparisons (star_level2)')
cursor.execute('CREATE INDEX IF NOT EXISTS current_comparisons__normalized_method2 ON current_comparisons (normalized_method2)')
